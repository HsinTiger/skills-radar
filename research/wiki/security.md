...
- `PROVEN` 中立且可用的 domain 樣本：**266**（母體 4.92%）
- `PROVEN` production：**65.0%**（maturity 有效樣本 266）
- `PROVEN` agent target：**9.8%**（target 有效樣本 265）
...
|---|---:|---:|
| 調度 (`orchestrate`) | 6 / 41.4 | 0.15x |
| 生成 (`generate`) | 16 / 58.4 | 0.27x |
