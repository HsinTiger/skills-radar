...
- `PROVEN` 中立且可用的 domain 樣本：**292**（母體 5.19%）
- `PROVEN` production：**64.1%**（maturity 有效樣本 287）
- `PROVEN` agent target：**9.3%**（target 有效樣本 279）
...
|---|---:|---:|
| 調度 (`orchestrate`) | 6 / 44.0 | 0.14x |
| 生成 (`generate`) | 16 / 62.4 | 0.26x |
