...
- `PROVEN` 中立且可用的 domain 樣本：**122**（母體 2.17%）
- `PROVEN` production：**53.3%**（maturity 有效樣本 120）
- `PROVEN` agent target：**2.5%**（target 有效樣本 121）
...
|---|---:|---:|
| 生成 (`generate`) | 1 / 26.1 | 0.04x |
| 配置 (`configure`) | 5 / 20.2 | 0.25x |
