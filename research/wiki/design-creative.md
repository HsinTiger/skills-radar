...
- `PROVEN` 中立且可用的 domain 樣本：**335**（母體 6.01%）
- `PROVEN` production：**38.0%**（maturity 有效樣本 332）
- `PROVEN` agent target：**7.4%**（target 有效樣本 326）
...
|---|---:|---:|
| 分析 (`analyze`) | 7 / 41.7 | 0.17x |
| 配置 (`configure`) | 10 / 56.6 | 0.18x |
| 調度 (`orchestrate`) | 13 / 51.8 | 0.25x |
