...
- `PROVEN` 中立且可用的 domain 樣本：**93**（母體 1.67%）
- `PROVEN` production：**64.8%**（maturity 有效樣本 91）
- `PROVEN` agent target：**1.1%**（target 有效樣本 91）
...
|---|---:|---:|
| 調度 (`orchestrate`) | 2 / 13.8 | 0.14x |
| 配置 (`configure`) | 5 / 15.1 | 0.33x |
