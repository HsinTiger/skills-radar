...
- `PROVEN` 中立且可用的 domain 樣本：**88**（母體 1.63%）
- `PROVEN` production：**63.6%**（maturity 有效樣本 88）
- `PROVEN` agent target：**1.1%**（target 有效樣本 88）
...
|---|---:|---:|
| 調度 (`orchestrate`) | 2 / 13.7 | 0.15x |
| 配置 (`configure`) | 5 / 15.0 | 0.33x |
