...
- `PROVEN` 中立且可用的 domain 樣本：**166**（母體 3.07%）
- `PROVEN` production：**29.5%**（maturity 有效樣本 166）
- `PROVEN` agent target：**1.8%**（target 有效樣本 166）
...
|---|---:|---:|
| 配置 (`configure`) | 5 / 28.3 | 0.18x |
| 調度 (`orchestrate`) | 5 / 25.8 | 0.19x |
| 分析 (`analyze`) | 6 / 20.8 | 0.29x |
