...
- `PROVEN` 中立且可用的 domain 樣本：**182**（母體 2.97%）
- `PROVEN` production：**27.2%**（maturity 有效樣本 180）
- `PROVEN` agent target：**1.7%**（target 有效樣本 180）
...
|---|---:|---:|
| 配置 (`configure`) | 5 / 29.0 | 0.17x |
| 調度 (`orchestrate`) | 5 / 26.1 | 0.19x |
| 分析 (`analyze`) | 6 / 21.5 | 0.28x |
