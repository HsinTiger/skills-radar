...
- `PROVEN` 中立且可用的 domain 樣本：**308**（母體 5.48%）
- `PROVEN` production：**21.2%**（maturity 有效樣本 307）
- `PROVEN` agent target：**5.2%**（target 有效樣本 308）
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-28 | 1 | 303 | 5.61% | 21.5% | +0 | initial ingest |
